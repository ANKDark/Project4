// src/components/Admin/Account/EditAccountAdmin.jsx
...
export default function EditAccountAdmin({
    ...
    const [formData, setFormData] = useState({
        ...
        password: '',
        role: adminData.role || 0,
        status: adminData.status || 1,
        avatar: null,
    });
    const [image, setImage] = useState(`http://127.0.0.1:8000${adminData.avatar}` || null);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/admin/updateAdmin', data, {
                headers: {
            ...
            setAlertMessage(`Cập nhật admin ${formData.name} thành công!`);
            Swal.fire({
                title: 'Thành công!',
                text: `Đã cập nhật admin ${formData.name}.`,
                icon: 'success',
            });
            ...
            setImage(adminData.avatar || null);
            setImageName('');
            setErrors({});
            onCancel();
        } catch (err) {
            ...
            Swal.fire({
                title: 'Thất bại!',
                text: `Cập nhật tài khoản thất bại, vui lòng kiểm tra lại. ${errorMessages}`,
                icon: 'error',
            });
        }
    };
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content bg-dark text-white border-secondary">
                    <div className="modal-header border-bottom border-secondary">
                        <h5 className="modal-title">Cập nhật Admin</h5>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body">
                            <div className="row g-3">
                                ...
                                <div className="col-md-6">
                                    <label className="form-label fw-semibold">Mật khẩu (để trống nếu không đổi)</label>
                                    <input
                                        type="password"
                                        name="password"
                                        className="form-control bg-dark text-white border-secondary"
                                ...
                                <div className="col-md-12">
                                    ...
                                    >
                                        {image ? (
                                            <img
                                                src={typeof image === 'string' ? image : URL.createObjectURL(formData.avatar)}
                                                alt="avatar"
