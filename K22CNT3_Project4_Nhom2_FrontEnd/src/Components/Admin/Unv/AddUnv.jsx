...
export default function AddUnv({
    onCancel,
    categories,
    editorConfig,
    editorContainerRef,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/admin/addUnv', data, {
                headers: {
            ...
            setAlertMessage(`Thêm trường ${formData.TenTruong} thành công!`);
            Swal.fire({
                title: 'Thành công!',
                text: `Thêm trường ${formData.TenTruong} thành công!`,
                icon: 'success',
            ...
            setShowAlert(true);
            setAlertType('error');
            setAlertMessage(`Thêm trường ${formData.TenTruong} thất bại: ${errorMessages}`);
            setErrors(err.response?.data?.errors || {});
            Swal.fire({
                title: 'Thất bại!',
                text: `Thêm trường ${formData.TenTruong} thất bại: ${errorMessages}`,
                icon: 'error',
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content bg-dark text-white border-secondary">
                    <div className="modal-header border-bottom border-secondary">
                        <h5 className="modal-title">Thêm mới trường</h5>
