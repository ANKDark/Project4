...
export default function EditProfileForm({
    ...
    const [previewImage, setPreviewImage] = useState(user.imgName || null);
                        ...
                        <form onSubmit={handleSubmitUser}>
                            <div className="text-center mb-3">
                                ...
                                >
                                    ...
                                    />
                                    <img
                                        src={previewImage || user.imgName || "https://static.vecteezy.com/system/resources/previews/009/292/244/large_2x/default-avatar-icon-of-social-media-user-vector.jpg"}
                                        alt="Avatar"
